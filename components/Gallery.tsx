...
const Gallery: React.FC = () => {
  ...
  return (
    <section ref={targetRef} className="h-[300vh] bg-[#050505] relative z-20">
      <div className="sticky top-0 flex h-screen items-center overflow-hidden perspective-1000 bg-[#050505]">
        ...
        <div className="absolute top-10 left-10 md:left-20 z-10 mix-blend-difference">
           <motion.div 
            ...
            >
               ...
               <span className="uppercase tracking-widest text-xs font-bold text-white">Scroll to Explore</span>
           </motion.div>
        </div>
